...
const POSITION_SEARCH_SORTS$ = {
  options: [
    ...
    { value: 'location_city', text: 'Location(city): A-Z', nonTandemOnly: true },
    { value: '-location_city', text: 'Location(city): Z-A', nonTandemOnly: true },
    { value: 'location_state', text: 'Location(state): A-Z', nonTandemOnly: true },
    { value: '-location_state', text: 'Location(state): Z-A', nonTandemOnly: true },
    { value: 'location_country', text: 'Location(country): A-Z', nonTandemOnly: true },
    { value: '-location_country', text: 'Location(country): Z-A', nonTandemOnly: true },
  ],
};
