...
export const CREATE_PANEL_MEETING_SUCCESS_TITLE = 'Panel Meeting created';
export const CREATE_PANEL_MEETING_SUCCESS = 'This Panel Meeting has been saved successfully.';
export const CREATE_PANEL_MEETING_ERROR_TITLE = 'Error creating Panel Meeting';
export const CREATE_PANEL_MEETING_ERROR = 'There was an issue attempting to save this Panel Meeting. Please try again.';
