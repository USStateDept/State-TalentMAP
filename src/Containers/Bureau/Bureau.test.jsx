...
import Bureau, { mapDispatchToProps } from './Bureau';
...
describe('Bureau', () => {
  ...
  it('calls the onDownloadClick function', () => {
    ...
    const wrapper = shallow(
      <Bureau.WrappedComponent getLogs={spy} />,
    );
  ...
  it('calls the onDownloadOne function', () => {
    const spy = sinon.spy();
    const wrapper = shallow(
      <Bureau.WrappedComponent getLogToDownload={spy} />,
    );
  ...
  it('calls the getLogById function', () => {
    const spy = sinon.spy();
    const wrapper = shallow(
      <Bureau.WrappedComponent getLog={spy} />,
    );
  ...
  it('is defined when receiving new props that trigger a download', () => {
    const wrapper = shallow(
      <Bureau.WrappedComponent logsIsLoading logToDownloadIsLoading />,
    );
  ...
  it('calls putAllSyncJobs on runAllJobs() if putAllSyncsIsLoading === false', () => {
    const spy = sinon.spy();
    const wrapper = shallow(
      <Bureau.WrappedComponent putAllSyncJobs={spy} putAllSyncsIsLoading={false} />,
    );
