...
const filters = {
  statusFilters: [{ code: 1, description: 'status' }, { code: 2, description: 'status' }, { code: 3, description: 'status' }],
  bureauFilters: [{ code: 1, description: 'bureau' }, { code: 2, description: 'bureau' }, { code: 3, description: 'bureau' }],
  orgFilters: [{ code: 1, description: 'org' }, { code: 2, description: 'org' }, { code: 3, description: 'org' }],
  gradeFilters: [{ code: 1, description: 'grade' }, { code: 2, description: 'grade' }, { code: 3, description: 'grade' }],
  skillsFilters: [{ code: 1, description: 'skill' }, { code: 2, description: 'skill' }, { code: 3, description: 'skill' }],
  cycleFilters: [{ code: 1, description: 'cycle' }, { code: 2, description: 'cycle' }, { code: 3, description: 'cycle' }],
  todFilters: [{ code: 1, description: 'tod' }, { code: 2, description: 'tod' }, { code: 3, description: 'tod' }],
  functionalBureauFilters: [{ code: 1, description: 'functional bureau' }, { code: 2, description: 'functional bureau' }, { code: 3, description: 'functional bureau' }],
};
...
export function publishablePositionsEditErrored(bool) {
  return {
    type: 'PUBLISHABLE_POSITIONS_EDIT_HAS_ERRORED',
    hasErrored: bool,
  };
}

export function publishablePositionsEditLoading(bool) {
  return {
    type: 'PUBLISHABLE_POSITIONS_EDIT_IS_LOADING',
    isLoading: bool,
  };
}

export function publishablePositionsEditSuccess(success) {
  return {
    type: 'PUBLISHABLE_POSITIONS_EDIT_SUCCESS',
    success,
  };
}
...
export function publishablePositionsFiltersFetchData() {
  return (dispatch) => {
    batch(() => {
      dispatch(publishablePositionsFiltersFetchDataSuccess({ filters }));
