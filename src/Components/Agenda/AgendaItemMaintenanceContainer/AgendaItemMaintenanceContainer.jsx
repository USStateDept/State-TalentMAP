...
const AgendaItemMaintenanceContainer = (props) => {
  ...
  const agendaID = 25486;
  console.log('agendaid', agendaID); // 25486
  // const agendaItem$ = useDataLoader(api().get, `/fsbid/agenda/agenda_items/${agendaID}/`);
  ...
  console.log('agendaItemLegs', agendaItemLegs);
