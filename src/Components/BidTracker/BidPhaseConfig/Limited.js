...
import {
  HAND_SHAKE_OFFERED_PROP, BID_TRACKER_TOOLTIP_TEXT, DRAFT_PROP,
  SUBMITTED_PROP, HAND_SHAKE_ACCEPTED_PROP, IN_PANEL_PROP, APPROVED_PROP,
  HAND_SHAKE_DECLINED_PROP, CLOSED_PROP, HAND_SHAKE_NEEDS_REGISTER_PROP,
  PRE_PANEL_PROP, DECLINED_PROP,
