...
export default function bidClassesFromCurrentStatus(bid = { status: 'draft' }) {
  ...
  const HAND_SHAKE_EVALUATING_TOOLTIP = BID_TRACKER_TOOLTIP_TEXT[HAND_SHAKE_OFFERED_PROP];
  const HAND_SHAKE_COMPLETE_TOOLTIP =
      BID_TRACKER_TOOLTIP_TEXT[HAND_SHAKE_ACCEPTED_PROP];
  const PANEL_TITLE_TOOLTIP = BID_TRACKER_TOOLTIP_TEXT[PRE_PANEL_PROP];
  const APPROVAL_TITLE_TOOLTIP = BID_TRACKER_TOOLTIP_TEXT[APPROVED_PROP];
  ...
  // Draft stage
    case DRAFT_PROP:
      ...
      bidClassObject.stages[HAND_SHAKE_OFFERED_PROP] = {
        ...
        tooltip: HAND_SHAKE_EVALUATING_TOOLTIP };
    ...
    case PRE_PANEL_PROP:
      ...
      bidClassObject.stages[HAND_SHAKE_ACCEPTED_PROP] = {
        ...
        number: HAND_SHAKE_ACCEPTED_NUMBER,
        tooltip: HAND_SHAKE_COMPLETE_TOOLTIP };
      bidClassObject.stages[IN_PANEL_PROP] = {
        ...DEFAULT_INCOMPLETE_OBJECT,
        date: IN_PANEL_DATE,
        title: 'Panel Pending',
