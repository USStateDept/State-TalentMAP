...
class BidControls extends Component {
  ...
  render() {
    const { biddersNumerator, biddersDenominator, isLoading } = this.props;
    return (
      <div className="usa-grid-full portfolio-controls">
        <div className="usa-width-one-half total-results-container">
          {
        ...
        <div className="usa-width-one-half portfolio-sort-container results-dropdown">
          <SelectForm
            id="porfolio-sort"
