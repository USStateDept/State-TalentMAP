...
import { modifyPermissionIsLoading } from 'actions/userRoles';
import { aboutContentIsLoading } from 'actions/aboutContent';
            ...
            <div className="usa-grid-full">
              {
                ...
                <table className={'delegateRole--table'}>
                  <thead>
                    <tr>
                      <th>userName { modifyPermissionIsLoading.toString() }
                        { aboutContentIsLoading.toString() }</th>
                      <th>Last, First{ usersIsLoading.toString() }</th>
...
const mapStateToProps = state => ({
  modifyPermissionIsLoading: state.modifyPermissionIsLoading.isLoading,
});
