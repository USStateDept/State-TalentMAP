    ...
    filters: [
      ...
      },
      {
        item: {
          ...
          endpoint: 'fsbid/reference/cycles/?active=true&ordering=name',
      ...
      },
      {
        item: {
          ...
          sort: 200,
          description: 'skill',
          endpoint: 'fsbid/reference/codes/',
      ...
      },
      {
        item: {
          ...
          endpoint: 'fsbid/reference/languages/?is_available=true',
      ...
      },
      {
        item: {
          ...
          sort: 500,
          description: 'language',
          endpoint: 'fsbid/reference/languages/',
          selectionRef: ENDPOINT_PARAMS.language,
          text: 'Choose languages',
          onlyProjectedVacancy: true,
        },
      ...
      },
      {
        item: {
          ...
          sort: 300,
          description: 'grade',
          endpoint: 'fsbid/reference/grades/?is_available=true',
      ...
      },
      {
        item: {
          ...
          sort: 300,
          description: 'grade',
          endpoint: 'fsbid/reference/grades/',
          selectionRef: ENDPOINT_PARAMS.grade,
          text: 'Choose grades',
          onlyProjectedVacancy: true,
        },
      ...
      },
      {
        item: {
          ...
          sort: 400,
          description: 'tod',
          endpoint: 'fsbid/reference/tourofduties/?is_available=true&ordering=months',
      ...
      },
      {
        item: {
          ...
          sort: 400,
          description: 'tod',
          endpoint: 'fsbid/reference/tourofduties/?ordering=months',
          selectionRef: ENDPOINT_PARAMS.tod,
          text: 'Choose Tour of Duty length',
          onlyProjectedVacancy: true,
          choices: [
      ...
      },
      {
        item: {
          ...
          sort: 100,
          description: 'region',
          endpoint: 'fsbid/reference/bureaus/?is_bureau=true&is_regional=true',
      ...
      },
      {
        item: {
          ...
          endpoint: 'fsbid/reference/dangerpay/',
